<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <img src="{{ asset('logo/qumap.png') }}" width="200px" height="80px">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('pengeluarann') }}">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('financialstatements/laporan') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('jurnal/bukubesar') }}">
                    <i class="fas fa fa-balance-scale"></i>
