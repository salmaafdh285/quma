            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('perusahaan.update', $perusahaan->id) }}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="mb-3"><label for="kodeperusahaanlabel">Kode Perusahaan</label><input class="form-control form-control-solid" id="kode_perusahaan" name="kode_perusahaan" type="text" placeholder="Contoh: PR-001" value="{{$perusahaan->kode_perusahaan}}" readonly></div>
