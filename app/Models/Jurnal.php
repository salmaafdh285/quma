...
class Jurnal extends Model
{
    ...
    // pencatatan jurnal
    public static function inputjurnal($id_perusahaan,$transaksi,$kelompok,$idtransaksi,$nominal)
    {
        ...
        $sql = "SELECT * 
                FROM transaksi_coa
                WHERE id_perusahaan = ? AND transaksi = ?
                AND kelompok = ?";
        $list = DB::select($sql,[$id_perusahaan,$transaksi,$kelompok]);
